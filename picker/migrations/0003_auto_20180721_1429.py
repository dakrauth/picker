    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='picker.PickerGrouping')),
        ...
        migrations.AlterField(
            model_name='preference',
            name='status',
            field=models.CharField(choices=[('ACTV', 'Active'), ('IDLE', 'Inactive'), ('SUSP', 'Suspended')], default='ACTV', max_length=4),
        ),
        migrations.AlterField(
            model_name='team',
            name='logo',
        ...
        migrations.AddField(
            model_name='pickergrouping',
            name='members',
            field=models.ManyToManyField(blank=True, to='picker.PickerMembership'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='pickerfavorite',
            name='team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='picker.Team'),
        ),
        migrations.AddField(
            model_name='pickerfavorite',
            name='user',

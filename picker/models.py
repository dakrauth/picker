...
class League(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('picker-home', [self.lower])

    # -------------------------------------------------------------------------
    def picks_url(self):
        return reverse('picker-picks', [self.lower])

    # -------------------------------------------------------------------------
    def results_url(self):
        return reverse('picker-results', [self.lower])

    # -------------------------------------------------------------------------
    def roster_url(self):
        return reverse('picker-roster', [self.lower])

    # -------------------------------------------------------------------------
    def teams_url(self):
        return reverse('picker-teams', [self.lower])

    # -------------------------------------------------------------------------
    def schedule_url(self):
        return reverse('picker-schedule', [self.lower])

    # -------------------------------------------------------------------------
    def manage_url(self):
        return reverse('picker-manage', [self.lower])
...
class Team(models.Model):
    ...
    # -------------------------------------------------------------------------
    def get_absolute_url(self):
        return reverse('picker-team', [self.league.lower, self.abbr])
